...
public class EventStopFragment extends Fragment {
    ...
    public static EventStopFragment newInstance() {
        EventStopFragment ecis = new EventStopFragment();
        return ecis;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_event_stop, container, false);
