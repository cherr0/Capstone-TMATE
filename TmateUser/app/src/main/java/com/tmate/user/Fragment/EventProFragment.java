...
public class EventProFragment extends Fragment {
    ...
    public static EventProFragment newInstance() {
        EventProFragment ecip = new EventProFragment();
        return ecip;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_event_pro, container, false);
