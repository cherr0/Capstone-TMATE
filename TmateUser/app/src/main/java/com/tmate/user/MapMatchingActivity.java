...
import com.tmate.user.databinding.ActivityMapMatchingBinding;
...
public class MapMatchingActivity extends AppCompatActivity implements TMapGpsManager.onLocationChangedCallback {
    ...
    private ActivityMapMatchingBinding b;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b= ActivityMapMatchingBinding.inflate(getLayoutInflater());
        setContentView(b.getRoot());
        //gps
        gps = new TMapGpsManager(MapMatchingActivity.this);
        ...
        together = intent.getExtras().getInt("together");
    ...
    public void setTrackingMode(boolean isShow) {
        ...
        if (isShow) {//gps 버튼을 켰을때
            mPermissionManager.request(this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, new PermissionManager.PermissionListener() {
                ...
                @Override
                public void denied() {
                    Toast.makeText(MapMatchingActivity.this, "위치정보 수신에 동의하지 않으시면 현재위치로 이동할 수 없습니다.", Toast.LENGTH_SHORT).show();
                }
            });
