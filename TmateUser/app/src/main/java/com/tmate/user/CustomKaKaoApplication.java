...
public class CustomKaKaoApplication extends Application {

    private static volatile CustomKaKaoApplication instance = null;
        ...
        public IApplicationConfig getApplicationConfig() {
            return new IApplicationConfig() {
                ...
                public Context getApplicationContext() {
                    return CustomKaKaoApplication.getGlobalApplicationContext();
                }
            };
        }
    }

    public static CustomKaKaoApplication getGlobalApplicationContext() {
        if(instance == null) {
